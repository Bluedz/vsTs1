...
import { PurchaseServiceSq } from './purchaseSq.service';
import { PurchaseSqTrackFromComponent } from './purchaseSqTrackForm.component';
import { PurchaseSqSearchComponent } from './purchaseSqSearch.component';

@Component({
    templateUrl: 'purchaseTrackSq-list.html'
})

export class PurchaseTrackSqComponent {
    ...
    constructor(private loadingCtrl: LoadingController, private navCtrl: NavController, private navParams : NavParams, private purchaseService: PurchaseServiceSq) {
    ...
    itemClick(purchase) {
        this.navCtrl.push(PurchaseSqTrackFromComponent, purchase);
    }

    adSearch(filters) {
        this.navCtrl.push(PurchaseSqSearchComponent, filters);
    }

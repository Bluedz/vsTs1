...
import { TMatFormComponent } from './tmatForm.component'
import { TMatSearchComponent } from './tmatSearch.component'
@Component({
  templateUrl: 'tmat-list.html',
  //styleUrls: ['../../../assets/css/default.scss'],
})
export class TMatComponent {
  public matList = [];
  public pageInfo;
  ...
  itemClick (mat) {
    ...
    this.navCtrl.push(TMatFormComponent, mat);
  }
  ...
  adSearch(filters) {
      this.navCtrl.push(TMatSearchComponent, filters);
  }
}
